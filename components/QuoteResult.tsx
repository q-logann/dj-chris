...
export default function QuoteResultCard({ quote }: { quote: QuoteResult }) {
  return (
    ...
    >
      <p className="font-body text-[11px] font-medium uppercase tracking-[0.18em] text-gold">
        // Estimated quote
      </p>
      ...
      <div className="mt-6 border-t border-white/15 pt-5">
        <p className="font-body text-[11px] font-medium uppercase tracking-[0.18em] text-white/55">
          Breakdown
        </p>
      ...
      <p className="mt-6 font-body text-xs text-white/55">{quote.disclaimer}</p>
    </div>
  );
}
